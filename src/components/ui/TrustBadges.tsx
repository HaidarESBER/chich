...
/**
 * TrustBadges component displays trust signals for security and guarantees
 *
 * Features:
 * - 4 key trust signals: Paiement sécurisé, Livraison gratuite, Satisfaction garantie, Service client
 * - Horizontal row on desktop, 2x2 grid on mobile
 * - Subtle background with rounded corners
 * - Icons use brand colors (primary with accent highlights)
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      {badges.map((badge, index) => (
        <motion.div
          ...
          className="flex flex-col items-center text-center p-6 bg-background-secondary rounded-[--radius-card] shadow-sm"
        >
          {/* Icon */}
          <motion.div
